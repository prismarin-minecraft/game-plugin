...
public enum Perk {
    ...
    DEADEYE(new ItemBuilder(Material.SPYGLASS).setName("§6Deadeye")
            ...
            .addLore(PrismarinConstants.LISTING_DOT + " §7marked for §a5 §7seconds")
            .addLore("§7")
            .addLore(PrismarinConstants.ARROW_RIGHT + " §cCons§8:")
            .addLore(PrismarinConstants.LISTING_DOT + " §7There is a §c7 §7seconds §7cooldown between hits")
            .addLore("§7")
            .addLore(PrismarinConstants.BORDER)
            .allFlags()
    ...
    FASTHANDS(new ItemBuilder(Material.BEACON).setName("§6§lFast Hands")
            ...
            .addLore(PrismarinConstants.LISTING_DOT + " §7Speed §a2")
            .addLore("§7")
            .addLore(PrismarinConstants.BORDER)
            .allFlags()
            .build(), 0, "§f七七七七七七七七象"),
